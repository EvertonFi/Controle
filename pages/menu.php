			...
			<aside class="app-sidebar">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="index.php"><span>Home</span></a></li>
						</ul>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#">
							...
							<span class="side-menu__label">Itens</span><i class="angle fa fa-angle-right"></i>
						</a>
						<ul class="slide-menu">
							<li><a href="listaItens.php" class="slide-item"> Lista de Itens</a></li>
							<li><a href="novoProduto.php" class="slide-item"> Adicionar Itens</a></li>
						</ul>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#">
				...
				<div class="container-fluid">
					<div class="d-flex">
						<a class="header-brand d-md-none" href="index.html">
							<img src="../assets/images/brand/logo-3.png" class="header-brand-img mobile-icon"
								alt="logo">
							<img src="../assets/images/brand/logo.png" class="header-brand-img desktop-logo mobile-logo"
								alt="logo">
						</a>
